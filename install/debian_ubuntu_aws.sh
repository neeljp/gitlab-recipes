...
sudo su -l gitlab -c "cd gitlab && bundle exec rake db:create RAILS_ENV=production"
sudo su -l gitlab -c "cd gitlab && bundle exec rake gitlab:setup RAILS_ENV=production"
